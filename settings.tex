...
% ******************************************************************************
% ******************************** STRING THEORY SHORTCUT ************************
\renewcommand{\v}{\boldsymbol{8_v}}
\newcommand{\s}{\boldsymbol{8_s}}
\renewcommand{\c}{\boldsymbol{8_c}}
\renewcommand{\i}{\boldsymbol{1}}
\newcommand{\eight}{\boldsymbol{8}}
\newcommand{\seven}{\boldsymbol{7}}